...
```
podman pull docker.io/eriksjolund/slurm-container-cluster
podman pull docker.io/eriksjolund/mysql-with-norouter
podman image tag docker.io/eriksjolund/slurm-container-cluster localhost/slurm-with-norouter
podman image tag docker.io/eriksjolund/mysql-with-norouter localhost/mysql-with-norouter
```
